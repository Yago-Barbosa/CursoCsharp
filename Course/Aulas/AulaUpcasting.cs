...
namespace Course.Aulas
{
    internal class AulaUpcasting
    {
        public static void UpDown()
        {
            ...
            BusinessAccount bacc = new BusinessAccount(1002, "Maria", 0.0, 500.0, 0.0);

            // Upcasting 

            Account acc1 = bacc;
            Account acc2 = new BusinessAccount(1003, "Bob", 0.0, 200.0, 0.0);
            Account acc3 = new SavingsAccount(1004, "Anna", 0.0, 0.01, 0.0);
