...
namespace Course.Aulas
{
    internal class AulaClasseAbstrata
    {
        public static void ClassesAbstratas()
        {
            ...
            list.Add(new SavingsAccount(1001, "Alex", 500.0, 0.01, 0.0));
            list.Add(new BusinessAccount(1002, "Maria", 500.0, 400.0, 0.0));
            list.Add(new SavingsAccount(1003, "Bob", 500.0, 0.01, 0.0));
            list.Add(new BusinessAccount(1004, "Anna", 500.0, 500.0, 0.0));
